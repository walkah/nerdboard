...
SCHEDULER.every '1m', :first_in => 0 do |job|
	nest = NestThermostat::Nest.new({email: nest_user,password: nest_password, temperature_scale: 'c'})
	...
	send_event('nest', { temp: "#{temp}&deg;" , state: state, away: away, leaf: leaf_src })
end
